      ...
      <header className="bg-white w-full flex justify-between sm:px-6 lg:px-8 items-center align-middle shadow-xl">
        <div className="flex">
          <a href="#" className="-m-1.5 p-4">
            <div className="flex justify-center items-center sm:text-4xl bg-opacity-80 sm:py-4 py-2 px-6 rounded-full shadow-lg w-20 h-16 font-poppins font-black text-white bg-[#1d0738] ">
              V
            </div>
          </a>
        ...
        <div className="flex flex-col space-x-2 capitalize items-center text-lg pr-[18px] sm:pr-0">
          <button
            className="flex font-poppins text-gray-500 justify-center items-center gap-2 border-opacity-50 py-2 sm:px-4 rounded-md hover:text-black sm:hover:bg-slate-100 transition ease-in-out delay-50"
          ...
          >
            ...
            <div className="sm:border-transparent hover:bg-slate-100 border-[1px] sm:p-0 p-3 rounded-lg border-gray-800 border-opacity-95">
              <CaretDown
                size={16}
                color="#040c1e"
                className={`hidden sm:block transition-transform duration-300 ease-in-out ${
              ...
              <List
                size={20}
                color="#040c1e"
                className={`sm:hidden transition-transform duration-300 ease-in-out ${
                  showProfile ? "transform rotate-180" : ""
                }`}
              />
            </div>
          ...
          <div
            id="profileModal"
            className={showProfile ? "hidden" : "z-10 absolute top-14"}
          >
